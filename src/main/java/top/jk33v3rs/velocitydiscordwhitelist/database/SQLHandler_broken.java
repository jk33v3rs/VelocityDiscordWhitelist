...
public class SQLHandler implements AutoCloseable {
     ...
     *
     * Executes a query and returns a single result using a ResultSet mapper function.
     *
     ...
     *
     * Executes a query and returns multiple results using a ResultSet mapper function.
     *
    ...
    public void updatePlayerPlaytime(String playerUuid, int additionalMinutes) {
        ...
        executeUpdate(userDataSql, new Object[]{playerUuid, additionalMinutes});
        executeUpdate(rankSql, new Object[]{playerUuid, additionalMinutes});
    }    /**
    ...
    public void updatePlayerAchievements(String playerUuid, int newAchievementCount) {
        ...
        // Execute both updates
        executeUpdate(userDataSql, new Object[]{playerUuid, newAchievementCount});
        executeUpdate(rankSql, new Object[]{playerUuid, newAchievementCount});
    }
    ...
    public void updatePlayerXP(String playerUuid, int newXPTotal) {
        ...
        executeUpdate(sql, new Object[]{playerUuid, newXPTotal});
    }
     ...
     * @param eventSource The specific source (e.g., advancement name, "playtime_tick")
     ...
     * @throws SQLException if database operation fails
     */
    public java.util.List<top.jk33v3rs.velocitydiscordwhitelist.models.XPEvent> getRecentXPEvents(String playerUuid, int limit) throws SQLException {
        String sql = """
    ...
    public int getPlayerXPSince(String playerUuid, Instant since) throws SQLException {
        ...
        return executeQueryForSingleResult(sql, new Object[]{playerUuid, Timestamp.from(since)}, rs -> rs.getInt("total_xp")).orElse(0);
    }
}
